...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.Join(grades, e => true, g => true, (e, g) => new { e.EName, e.Sal, g.Grade, g.Losal, g.Hisal }).Where(eg => eg.Sal >= eg.Losal && eg.Sal <= eg.Hisal).Select(eg => new { eg.EName, eg.Grade }).ToList(); ;
